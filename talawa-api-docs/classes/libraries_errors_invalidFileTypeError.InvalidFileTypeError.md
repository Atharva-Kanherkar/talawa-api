...
[src/libraries/errors/invalidFileTypeError.ts:6](https://github.com/PalisadoesFoundation/talawa-api/blob/0deccac/src/libraries/errors/invalidFileTypeError.ts#L6)
